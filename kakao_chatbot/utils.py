...
def make_devcard():
    dev_list = []
    dev_df = pd.read_csv('dev_20231127.csv',encoding='utf-8')
...
def make_velogcard():
    velog_list = [] 
    velog_df = pd.read_csv('velog_20231124.csv', encoding='utf-8')
...
def make_eventcard():
    event_list =[]
    event_df = pd.read_csv('contest_20231130.csv', encoding='utf-8')
